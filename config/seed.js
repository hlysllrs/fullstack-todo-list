  ...
  const items = await Item.create([
    {
      ...
      imageURL: '/img/products/eames-lounge-chair.avif',
      category: categories[0],
      price: 5795.00
    },
    {
      name: 'Eames Molded Plywood Lounge Chair',
      imageURL: '../../img/products/eames-lcw.avif',
      category: categories[0],
      price: 5.95
    },
    {
      name: 'Eames Molded Plastic Side Chair',
      imageURL: '../../img/products/eames-molded.avif',
